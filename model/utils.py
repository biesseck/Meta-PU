...
# from pointnet2_utils in Pointnet2_PyTorch
class GroupingOperation(Function):
    ...
    def forward(ctx, features, idx):
        ...
        # print(features.type)
        # return _ext.group_points(features.cpu(), idx).cuda()
        return _ext.group_points(features.type(torch.cuda.FloatTensor), idx)
...
# modified according to https://github.com/liruihui/PU-GAN/blob/19f149ef4034e0be90f87abcc305f704cdc82aa1/tf_ops/grouping/tf_grouping.py
class QueryBallPoint(Function):
    ...
    def forward(ctx, radius, nsample, xyz, new_xyz):
        ...
        Input:
            ...
            new_xyz: (batch_size, ndataset, 3) float32 array, input points
            xyz: (batch_size, npoint, 3) float32 array, query points
...
query_ball_point = QueryBallPoint.apply
